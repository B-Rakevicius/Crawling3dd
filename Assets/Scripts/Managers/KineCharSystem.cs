...
{
    /// <summary>
    /// The system that manages the simulation of KineMotor and PhysicsMover
    /// </summary>
    [DefaultExecutionOrder(-100)]
    public class KineCharSystem : MonoBehaviour
    {
        private static KineCharSystem _instance;

        public static List<KineMotor> CharacterMotors = new List<KineMotor>();
        ...
        public static void EnsureCreation()
        {
            if (_instance == null)
            {
                ...
                _instance = systemGameObject.AddComponent<KineCharSystem>();
        ...
        /// </summary>
        /// <returns></returns>
        public static KineCharSystem GetInstance()
        {
            return _instance;
        }
        ...
        /// <summary>
        /// Registers a KineMotor into the system
        /// </summary>
        public static void RegisterCharacterMotor(KineMotor motor)
        {
            CharacterMotors.Add(motor);
        }

        /// <summary>
        /// Unregisters a KineMotor from the system
        /// </summary>
        public static void UnregisterCharacterMotor(KineMotor motor)
        {
        ...
        /// <summary>
        /// Remembers the point to interpolate from for KineMotor and PhysicsMovers
        /// </summary>
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            {
                KineMotor motor = CharacterMotors[i];
        ...
        /// </summary>
        public static void Simulate(float deltaTime, List<KineMotor> motors, List<PhysicsMover> movers)
        {
...
#pragma warning restore 0162
        ...
        /// <summary>
        /// Initiates the interpolation for KineMotor and PhysicsMovers
        /// </summary>
