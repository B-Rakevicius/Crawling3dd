...
using CharacterState = KinematicCharacterController.Walkthrough.NoClipState2.CharacterState;
...
public class KineMotor : MonoBehaviour
{
...
#pragma warning restore 0649
    ...
    public bool LastMovementIterationFoundAnyGround;
    /// <summary>
    /// Index of this motor in KineMotor arrays
    /// </summary>
    [NonSerialized]
...
#pragma warning restore 0414
    ...
    {
        KineCharSystem.EnsureCreation();
        KineCharSystem.RegisterCharacterMotor(this);
    }

    private void OnDisable()
    {
        KineCharSystem.UnregisterCharacterMotor(this);
    }
    ...
    private bool InternalIsColliderValidForCollisions(Collider coll)
    {
        ...
        MyController makeshiftController = this.gameObject.GetComponent<MyController>(); // get nx component nx of this nx
